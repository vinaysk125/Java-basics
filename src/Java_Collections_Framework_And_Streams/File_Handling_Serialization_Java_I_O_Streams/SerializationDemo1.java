...
public class SerializationDemo1 {
    public static void main(String[] args) {
        ...
        students.add(new Student1(1, "Vinay", 85));
        students.add(new Student1(2, "Karan", 90));
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("students.dat"))) {
            List<Student1> loaded = (List<Student1>) ois.readObject();
            System.out.println("🔄 Deserialized student data:");
            for (Student1 s : loaded) System.out.println(s);
        }
